	...
	<div class ='container'>
			...
			<div class="col-md-offset-0 col-md-10">
				...
				<form class="form" method="post">
					<div class="panel-body">
						...
						Objetivo:
						<input type="text" id="objetivo" name='objetivo' class="form-control" placeholder="<?php echo $objetivo; ?>" required autofocus readonly="<?php echo $aprobada ?>">
						<div id="e_objetivo"></div><!--Aquí se muestran los mensajes de error para este input(ver validadorSRO.js)-->
						Resumen:
						<input type="text" id="resumen" name='resumen' class="form-control" placeholder="<?php echo $resumen; ?>" required autofocus readonly="<?php echo $aprobada ?>">
		...
		if( (isset($_POST['titulo_de_tesis'])) && (isset($_POST['objetivo'])) && (isset($_POST['resumen'])) && (isset($_POST['documento'])) ){
			...
			//header('Location: Pages/PerfilAlumno.php');
				...
				echo "<script type='text/javascript'> alert('Hubo un error, inténtalo después'); window.location.href='modfificarSRO.php'; </script>";
			}
		}
		?>
		<div class="container">
